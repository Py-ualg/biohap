...
The full example is in this [notebook](https://github.com/emo-bon/momics-demos/blob/main/wfs_extra/03_fuseki_emobon_GH.ipynb).
...
First, start a `jupyterlab` server

```bash
# in the momics-demos/momics-demos folder
python -m jupyterlab
```
