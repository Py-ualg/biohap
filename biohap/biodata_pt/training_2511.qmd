...
We will use [fuseki](https://jena.apache.org/documentation/fuseki2/index.html) server for a SPARQL endpoint. It is a java ndpoint, therefore, you might need to install `java` first if `java -version` command does not return anything.
