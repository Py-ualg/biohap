...
1. One approach could be the permonova test removing the taxa one by one. Permonova is implemented in [`marine-omics-methods`](https://github.com/emo-bon/marine-omics-methods) ([marine-omics](https://pypi.org/project/marine-omics/) on PyPI).
