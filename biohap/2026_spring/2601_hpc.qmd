...
This hands-on workshop introduces participants to the power of high-performance computing (HPC), guiding them toward independent use through practical examples on the `CCMAR-CETA` server. The workshop also includes a presentation from HPCVLAB at UAlg on the national `Deucalion` FCCN infrastructure.
